...
/* Rating */
const min_rate = new Component('meta', {'property' : '','content' : '1' })
const max_rate = new Component('meta', {'property' : '','content' : '5' })
const current_rate = new Component('meta', {'property' : '','content' : '4' })
...
// Create all meta you need & create a main block for seo props
